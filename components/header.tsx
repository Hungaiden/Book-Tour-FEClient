      ...
      <div className="container flex h-16 items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-2">
          <Sheet>
            ...
            <SheetContent side="left" className="border-r-ocean-200">
              <SheetHeader>
                <SheetTitle className="text-ocean-700">Menu</SheetTitle>
                <SheetDescription>Navigate through our travel offerings</SheetDescription>
              </SheetHeader>
                ...
                <Link
                  ...
                  className={`group flex items-center rounded-md px-3 py-2 text-sm font-medium transition-colors ${
                    isActive('/') && pathname === '/'
                      ...
                      : 'hover:bg-ocean-50 hover:text-ocean-700'
                  }`}
                >
                  Home
                </Link>
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 border-ocean-100">
              {user ? (
                <>
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/profile" className="hover:text-ocean-700 cursor-pointer">
                      Thông tin cá nhân
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/bookings" className="hover:text-ocean-700 cursor-pointer">
                      Đặt chỗ của tôi
                    </Link>
                  </DropdownMenuItem>
                ...
                <>
                  <DropdownMenuLabel className="text-ocean-700">Tài khoản</DropdownMenuLabel>
                  <DropdownMenuSeparator className="bg-ocean-100" />
                  <DropdownMenuItem asChild>
                    <Link href="/login" className="hover:text-ocean-700 cursor-pointer">
                      Đăng nhập
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/register" className="hover:text-ocean-700 cursor-pointer">
                      Đăng ký
                    </Link>
                  </DropdownMenuItem>
                </>
