...
const EditTour = (props: EditTourProps) => {
  const router = useRouter();
  const params = React.use(props.params);
  const id = params.id;

  const [formData, setFormData] = useState({
    name: 'Hà Nội - Hạ Long 3 Ngày',
    category: 'beach',
    price: '2500000',
    duration: '3 ngày 2 đêm',
    description: 'Khám phá vịnh Hạ Long, một trong những kỳ quan thế giới',
    destination: 'Quảng Ninh',
    maxParticipants: '30',
    inclusions: 'Xe đ接迎, Khách sạn 3 sao, Ăn sáng',
    highlights: 'Hang Sơn Đông, Đảo Titop, Động Thiên Cung',
  });
