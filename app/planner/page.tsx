    ...
    try {
      ...
      if (response.tours && response.tours.length > 0) {
        ...
        toast({
          ...
          description: 'Không có tour nào phù hợp với yêu cầu của bạn',
        });
      }
    } catch (error) {
      toast({
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Lập Kế Hoạch Du Lịch Thông Minh với AI
                </h1>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Để AI tiên tiến của chúng tôi tạo lịch trình hoàn hảo dựa trên sở thích, ngân sách
                  và phong cách du lịch của bạn.
                </p>
              </div>
            </div>
            <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_2fr]">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Điền thông tin mong muốn và AI của chúng tôi sẽ tạo lịch trình cá nhân hóa cho
                    bạn.
                  </CardDescription>
                </CardHeader>
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-2 mt-2">
                                ...
                                {tour.is_featured && (
                                  <Badge variant="secondary">Tour nổi bật</Badge>
                                )}
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Giá trên đã bao gồm thuế và phí
                                </p>
                              </div>
                            </div>
                            <div>
                  ...
                  <div className="flex items-center justify-center h-[400px]">
                    <p className="text-muted-foreground">
                      {searched
                        ...
                        : 'Nhập thông tin và nhấn "Tìm tour phù hợp" để xem kết quả'}
                    </p>
                  </div>
                )}
              </div>
